...
export class NgToggleComponent implements AfterViewInit, AfterContentInit, AfterViewChecked, OnChanges {
  ...
  onLabel: NgToggleLabelDirective;
  offLabel: NgToggleLabelDirective;
  ...
  ngAfterContentInit(): void {
      const onElement: NgToggleLabelDirective =
        this.labelElements.find((item: NgToggleLabelDirective) => item.forLabel.toLowerCase() === 'on');
      const offElement: NgToggleLabelDirective =
        this.labelElements.find((item: NgToggleLabelDirective) => item.forLabel.toLowerCase() === 'off');
