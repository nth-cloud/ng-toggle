...
const NG_TOGGLE_MODULE_NAME = 'NgToggleModule';
const NG_TOGGLE_PACKAGE_NAME = '@nth-cloud/ng-toggle';

/**
 * Patches main application module by adding 'NgToggleModule' import.
 *
 ...
 *
 */
export function addNgToggleModuleToAppModule(options: Schema): Rule {
	return async (host: Tree) => {
		...
		const changes = addImportToModule(
			appModuleSource,
			appModuleFilePath,
			NG_TOGGLE_MODULE_NAME,
			NG_TOGGLE_PACKAGE_NAME,
		);
